<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="binary.aspx.cs" Inherits="nabane.binary" %>
			...
			<section id="main">
				...
				<!-- One -->
					<section id="one" class="wrapper style1">
						...
						<div class="content">
                            <h2>Show Binary text file</h2>
                            <asp:Literal ID="Literal_binary" runat="server"></asp:Literal>
						</div>
					</section>
